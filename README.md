This this just a dummy repo for the application example "ae-hw-engineering". It works as a placeholder so that the package with the application can be hosted.
